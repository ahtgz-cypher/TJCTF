...
```
┌──(kali㉿kali)-[~/ctf/TCTF/check_the_fine_print]
└─$ file logo.png 
...
Directory                       : .
File Size                       : 65 kB
File Modification Date/Time     : 2026:05:11 20:12:56-04:00
File Access Date/Time           : 2026:05:18 22:05:26-04:00
File Inode Change Date/Time     : 2026:05:16 22:05:17-04:00
...
```
I realize this file contain many data throughs command binwalk, and i try binwalk -e file:
```
┌──(kali㉿kali)-[~/ctf/TCTF/check_the_fine_print/_logo.png-0.extracted]
└─$ ls 
001.png  033.png  065.png  097.png  129.png  161.png  193.png  225.png
002.png  034.png  066.png  098.png  130.png  162.png  194.png  226.png
003.png  035.png  067.png  099.png  131.png  163.png  195.png  227.png
004.png  036.png  068.png  100.png  132.png  164.png  196.png  228.png
005.png  037.png  069.png  101.png  133.png  165.png  197.png  229.png
006.png  038.png  070.png  102.png  134.png  166.png  198.png  230.png
007.png  039.png  071.png  103.png  135.png  167.png  199.png  231.png
008.png  040.png  072.png  104.png  136.png  168.png  200.png  232.png
009.png  041.png  073.png  105.png  137.png  169.png  201.png  233.png
010.png  042.png  074.png  106.png  138.png  170.png  202.png  234.png
011.png  043.png  075.png  107.png  139.png  171.png  203.png  235.png
012.png  044.png  076.png  108.png  140.png  172.png  204.png  236.png
013.png  045.png  077.png  109.png  141.png  173.png  205.png  237.png
014.png  046.png  078.png  110.png  142.png  174.png  206.png  238.png
015.png  047.png  079.png  111.png  143.png  175.png  207.png  239.png
016.png  048.png  080.png  112.png  144.png  176.png  208.png  240.png
017.png  049.png  081.png  113.png  145.png  177.png  209.png  241.png
018.png  050.png  082.png  114.png  146.png  178.png  210.png  242.png
019.png  051.png  083.png  115.png  147.png  179.png  211.png  243.png
020.png  052.png  084.png  116.png  148.png  180.png  212.png  244.png
021.png  053.png  085.png  117.png  149.png  181.png  213.png  245.png
022.png  054.png  086.png  118.png  150.png  182.png  214.png  246.png
023.png  055.png  087.png  119.png  151.png  183.png  215.png  247.png
024.png  056.png  088.png  120.png  152.png  184.png  216.png  248.png
025.png  057.png  089.png  121.png  153.png  185.png  217.png  29
026.png  058.png  090.png  122.png  154.png  186.png  218.png  29.zlib
027.png  059.png  091.png  123.png  155.png  187.png  219.png  37C4.zip
028.png  060.png  092.png  124.png  156.png  188.png  220.png
029.png  061.png  093.png  125.png  157.png  189.png  221.png
030.png  062.png  094.png  126.png  158.png  190.png  222.png
031.png  063.png  095.png  127.png  159.png  191.png  223.png
032.png  064.png  096.png  128.png  160.png  192.png  224.png
```
and i see many file png in this, it just files have numbers 1-224 and other three files are 29, 29.zlib, 37C4.zip. I try unzip file 29.zlib and 37C4.zip and i just received files similar file initial. After that i use monatge to read file png and combine the images and it be errors:
```
┌──(kali㉿kali)-[~/…/TCTF/check_the_fine_print/_logo.png.extracted/hidden]└─$ montage $(ls *.png | sort -V) -tile 31x8 -geometry +0+0 out.pngmontage: Unknown compression method in IHDR 002.png' @ warning/png.c/MagickPNGWarningHandler/1531.
montage: Invalid IHDR data 002.png' @ error/png.c/MagickPNGError/1305.
```
Unknown compression method in IHDR
Invalid IHDR data
It means file has IHDR be wrong
```
File .png has structure: 
PNG signature
IHDR
IDAT
IEND
and in this challenge, author has been hide data in IHDR of pngs. IHDR is first chunk after signature, it contain basic information of iamge: length, width, bit depth, color type, compression method, filter method, interlace method. In right PNG, byte compression method in IHDR always is 00. If it different 00, image would be report an error:
Unknown compression method in IHDR
Invalid IHDR data
The author has been use it to hiden flag:
file has compression method = 00 -> bit 0
file has compression medthod != 00 -> bit 1
It means files 001.png 002.png,..., it don't important what content. Each file just represent one bit
and i think i will write command read byte 26 in files png. Why byte 26?
```
0-7     PNG signature
8-11    độ dài chunk IHDR
12-15   chữ "IHDR"
16-19   width
20-23   height
24      bit depth
...
data = open(f, "rb").read()
b = data[26]
bits += "0" if b == 0 else "1"
It mean if it is 00, i will take bit 0 and if it not 00, i will take bit 1, and complete script:
python3 - << 'EOF'
import glob

bits = ""

for f in sorted(glob.glob("hidden/*.png")):
    data = open(f, "rb").read()
    b = data[26]
    bits += "0" if b == 0 else "1"
...
EOF
```
And i take the flag: tjctf{wow_you_actually_read_it}

### Conclusion
Challenge has been hiden bits in files, and we read byte 26 of files and if it is 00 -> 0, and != 00 -> 1
and we combine it and get the flag
